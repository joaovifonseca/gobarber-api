...
describe('UpdateUserAvatar', function () {
    ...
    it('should not be able to update avatar from non existing user', function () { return __awaiter(void 0, void 0, void 0, function () {
        var fakeUserRepository, fakeStorageProvider, updateUserAvatar, test, _a;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 2:
                    _a.apply(void 0, [_b.sent()]).rejects.toBeInstanceOf(AppError_1.default);
                    return [2 /*return*/];
            }
        });
    }); });
    it('should delete old avatar when updatubg new one', function () { return __awaiter(void 0, void 0, void 0, function () {
